class Motocicleta():
    ...
    def arrancar(self):
        if self.motor:
            print("Se escucha un ruido ¿El motor ya estaba arrancado?.")
        else:
...
motocicleta_Honda_1 = Motocicleta("Roja y blanca", "45663-FHDY", 10, 2, "Honda", "YZT_R1", "20/02/2020", 288, 199, 17)

motocicleta_Honda_1 = Motocicleta(
...
motocicleta_Honda_1.precio = 27000
